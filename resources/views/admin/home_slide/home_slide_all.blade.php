    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
       <input name="home_slides" class="form-control" type="file"  id="image">
                </div>
            </div>
            <!-- end row -->
               ...
               <div class="col-sm-10">
                <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($homeslide->home_slides))? url( $homeslide->home_slides):url('upload/no_image.jpg') }}" alt="Card image cap">
